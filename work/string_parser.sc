...
import fpinscala.parsing._
  ...
  object MyParsers extends Parsers[Parser] {
	...
	MyParsers.run(MyParsers.string("c"))("ab")//> res0: Either[string_parser.ParseError,String] = Left(ParseError(List((Locat
                                                  //| ion(ab,0),Expected: c)),List()))
