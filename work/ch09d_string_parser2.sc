...
//  type Parser[+A] = String => Either[ParseError, A]
  ...
  }                                               //> firstNonmatchingIndex: (s1: String, s2: String, offset: Int)Int
  ...
  import exercise.MyParser2.MyParsers.ParserOps._
	...
	run(product(string("abra"), string ("cadabra")))("abracAdabra")
                                                  //> res0: Either[exercise.MyParser2.ParseError,(String, String)] = Left(ParseEr
                                                  //| ror(List((Location(abracAdabra,5),'cadabra')),List()))
}